...
g: AppContext = LocalProxy(partial(_ctx_lookup, [_app_ctx_stack], "g"))  # type: ignore
request: Request = LocalProxy(partial(_ctx_lookup, [_request_ctx_stack], "request"))  # type: ignore
session: Session = LocalProxy(partial(_ctx_lookup, [_request_ctx_stack, _websocket_ctx_stack], "session"))  # type: ignore  # noqa: E501
